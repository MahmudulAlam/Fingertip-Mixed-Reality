class argHandler(dict):
    ...
    def setDefaults(self):
        self.define('imgdir', './Images/', 'path to testing directory with images')
        ...
        self.define('labels', 'cfg/labels.txt', 'path to labels file')
        self.define('backup', 'weights/hand_weights/', 'path to backup folder')
