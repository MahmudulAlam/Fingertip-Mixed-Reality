...
model = dtfd()
model.summary()
model.load_weights('../compare/weights/dtfd.h5')
...
print('')
print('d' + str(participant_id) + '_true_yolo_2 = ', D.tolist(), ';')
print('d' + str(participant_id) + '_pred_yolo_2 = ', D_hat.tolist(), ';')
print('')
print('s' + str(participant_id) + '_true_yolo_2 = ', scale, ';')
print('s' + str(participant_id) + '_pred_yolo_2 = ', scale_hat, ';')
print('')
print('r' + str(participant_id) + '_true_yolo_2 = ', rotate, ';')
print('r' + str(participant_id) + '_pred_yolo_2 = ', rotate_hat, ';')
print('')
print('t' + str(participant_id) + '_true_yolo_2 = ', translate, ';')
print('t' + str(participant_id) + '_pred_yolo_2 = ', translate_hat, ';')
print('')
