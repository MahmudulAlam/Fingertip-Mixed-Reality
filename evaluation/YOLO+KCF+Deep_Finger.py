...
model = deepFinger()
model.summary()
model.load_weights('../compare/weights/deepfinger.h5')
...
print('')
print('d' + str(participant_id) + '_true_yolo_1 = ', D.tolist(), ';')
print('d' + str(participant_id) + '_pred_yolo_1 = ', D_hat.tolist(), ';')
print('')
print('s' + str(participant_id) + '_true_yolo_1 = ', scale, ';')
print('s' + str(participant_id) + '_pred_yolo_1 = ', scale_hat, ';')
print('')
print('r' + str(participant_id) + '_true_yolo_1 = ', rotate, ';')
print('r' + str(participant_id) + '_pred_yolo_1 = ', rotate_hat, ';')
print('')
print('t' + str(participant_id) + '_true_yolo_1 = ', translate, ';')
print('t' + str(participant_id) + '_pred_yolo_1 = ', translate_hat, ';')
print('')
...
print('{0} & {1} & {2} & {3} & {4} & {5}'.format(np.round(d_d_hat, 4),
