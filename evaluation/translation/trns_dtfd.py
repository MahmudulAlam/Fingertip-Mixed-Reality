...
print('')
print('t_x' + str(user) + '_true_2 = ', translate_x, ';')
print('t_x' + str(user) + '_pred_2 = ', translate_x_hat, ';')
print('t_y' + str(user) + '_true_2 = ', translate_y, ';')
print('t_y' + str(user) + '_pred_2 = ', translate_y_hat, ';')
print('')
